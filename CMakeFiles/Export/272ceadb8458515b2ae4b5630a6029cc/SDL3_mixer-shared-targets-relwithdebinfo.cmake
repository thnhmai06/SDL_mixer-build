...
set_target_properties(SDL3_mixer::SDL3_mixer-shared PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/SDL3_mixer.lib"
...
set_target_properties(SDL3_mixer::ogg PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/ogg-0.dll"
  )
...
set_target_properties(SDL3_mixer::opus PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/opus-0.dll"
  )
...
set_target_properties(SDL3_mixer::opusfile PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/opusfile-0.dll"
  )
...
set_target_properties(SDL3_mixer::gme PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/gme.dll"
  )
...
set_target_properties(SDL3_mixer::xmp_shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/libxmp.dll"
  )
...
set_target_properties(SDL3_mixer::WavPack PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/libwavpack-1.dll"
  )
